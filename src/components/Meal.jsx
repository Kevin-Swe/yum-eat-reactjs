    ...
    <div className='max-w-[1520px] m-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-center m-3'>
            <div className='flex justify-center md:justify-center'>
                ...
                <button onClick={()=> filterCat('noodle')} className='m-1 border-orange-700 text-white  bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Noddle</button>
                <button onClick={()=> filterCat('fastfood')} className='m-1 border-orange-700 text-white  bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Food</button>
            </div>
        </div>
                ...
                foods.map((item)=>(
                   <div className='border-none hover:scale-105 duration-300' key={item.id}>
                     ...
                     <div className='pl-2 py-4'>
                        <p className='flex items-center text-indigo-600'>View More<ArrowRightIcon className='w-5 ml-2'/></p>
                     </div>
                   </div>
